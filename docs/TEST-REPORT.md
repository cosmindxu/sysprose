...
| Validation engine — all 15 rules (pos/neg) | `U validation.rules` (33 cases); `I pipeline.validate` | PASS | — |
...
| Validation — 15 rules incl. 3 KerML semantic rules | `U validation.rules`; `I pipeline.validate` | PASS |
