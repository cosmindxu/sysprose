...
| Validation — 25 rules incl. the KerML semantic ones (value conformance, redefinition conformance, units and dimensions) | `U validation.rules`; `I pipeline.validate` | PASS |
...
SysML v2 standard family — all six read **Covered** — with **3202 green automated
checks** (**3074** unit/integration/conformance/server/interop across **146 files**,
...
*End of report. Counts and verdicts derived from a live `vitest run` (3074 passed /
0 skipped across 146 files) and Playwright (128/128 across 78 spec files), plus
