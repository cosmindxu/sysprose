...
SysML v2 standard family — all six read **Covered** — with **3430 green automated
checks** (**3302** unit/integration/conformance/server/interop across **151 files**,
...
*End of report. Counts and verdicts derived from a live `vitest run` (3302 passed /
0 skipped across 151 files) and Playwright (128/128 across 78 spec files), plus
