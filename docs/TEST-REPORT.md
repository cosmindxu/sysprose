...
SysML v2 standard family — all six read **Covered** — with **3404 green automated
checks** (**3276** unit/integration/conformance/server/interop across **150 files**,
...
*End of report. Counts and verdicts derived from a live `vitest run` (3276 passed /
0 skipped across 150 files) and Playwright (128/128 across 78 spec files), plus
