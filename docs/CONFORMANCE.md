...
| Full automated suite | **2056 passed / 0 failed / 0 skipped** across **126 files** + **127 E2E** across **78 spec files** = **2183 green** (measured 2026-09-05) |
...
# Full unit + integration + conformance suite (2056 pass / 0 skip, 126 files)
