...
| Full automated suite | **2116 passed / 0 failed / 0 skipped** across **128 files** + **128 E2E** across **78 spec files** = **2244 green** (measured 2026-09-05) |
...
# Full unit + integration + conformance suite (2116 pass / 0 skip, 128 files)
