...
| Full automated suite | **3251 passed / 0 failed / 0 skipped** across **150 files** + **128 E2E** across **78 spec files** = **3379 green** (measured 2026-09-16) |
...
# Full unit + integration + conformance suite (3251 pass / 0 skip, 150 files)
