...
| Full automated suite | **1910 passed / 0 failed / 0 skipped** across **120 files** + **127 E2E** across **78 spec files** = **2037 green** (measured 2026-09-04) |
...
# Full unit + integration + conformance suite (1910 pass / 0 skip, 120 files)
