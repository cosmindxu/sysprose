...
| Full automated suite | **2177 passed / 0 failed / 0 skipped** across **129 files** + **128 E2E** across **78 spec files** = **2305 green** (measured 2026-09-05) |
...
# Full unit + integration + conformance suite (2177 pass / 0 skip, 129 files)
