...
| Full automated suite | **1860 passed / 0 failed / 0 skipped** across **119 files** + **127 E2E** across **78 spec files** = **1987 green** (measured 2026-09-04) |
...
# Full unit + integration + conformance suite (1860 pass / 0 skip, 119 files)
