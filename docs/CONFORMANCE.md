...
| Full automated suite | **2021 passed / 0 failed / 0 skipped** across **125 files** + **127 E2E** across **78 spec files** = **2148 green** (measured 2026-09-04) |
...
# Full unit + integration + conformance suite (2021 pass / 0 skip, 125 files)
