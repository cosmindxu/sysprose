...
| Full automated suite | **2106 passed / 0 failed / 0 skipped** across **128 files** + **128 E2E** across **78 spec files** = **2234 green** (measured 2026-09-05) |
...
# Full unit + integration + conformance suite (2106 pass / 0 skip, 128 files)
