...
| Full automated suite | **1961 passed / 0 failed / 0 skipped** across **122 files** + **127 E2E** across **78 spec files** = **2088 green** (measured 2026-09-04) |
...
# Full unit + integration + conformance suite (1961 pass / 0 skip, 122 files)
