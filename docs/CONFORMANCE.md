...
| Full automated suite | **2971 passed / 0 failed / 0 skipped** across **145 files** + **128 E2E** across **78 spec files** = **3099 green** (measured 2026-09-10) |
...
# Full unit + integration + conformance suite (2971 pass / 0 skip, 145 files)
