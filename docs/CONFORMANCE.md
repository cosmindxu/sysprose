...
| Full automated suite | **2965 passed / 0 failed / 0 skipped** across **145 files** + **128 E2E** across **78 spec files** = **3093 green** (measured 2026-09-09) |
...
# Full unit + integration + conformance suite (2965 pass / 0 skip, 145 files)
