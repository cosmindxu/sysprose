...
export const PATTERN_NAMES: readonly string[] = [
  ...
  'cover',
  // AFTER `cover` and before the pair, for the same reason.
  'recovery',
  'existence',
  'response',
];
