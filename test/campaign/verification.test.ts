...
describe('L8 — fault-tree: cut sets from contract-failure injection', () => {
  ...
  it('the census reads 0 across the shipped corpus, over a non-zero number of machines', async () => {
    ...
    // both together.
    expect(machines, 'docs/AGENT-AUTHORING-CAMPAIGN.md says "twenty-nine machines"; re-measure and edit both').toBe(29);
    expect(read('docs/AGENT-AUTHORING-CAMPAIGN.md')).toContain('twenty-nine machines between them');
  });
